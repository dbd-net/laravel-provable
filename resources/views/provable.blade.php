            ...
            <div class="bg-dark p-4">
                <div class="container">
                    <div class="col">
                        ...
                        <p class="text-muted">Provably fair is a way to prove that a randomly generated number is not manipulated. The way this is done is through the use of cryptographic hashes in which you (the client) provide a random seed and the game (the server) provides a random seed. The 2 seeds are then put together as a single seed and used to generate a random number for a game.</p>
                    </div>
                    <div class="col">
                        <h4 class="text-white">How It Works</h4>
                        <p class="text-muted">The client is auto-assigned a seed that they can use or change. The server also creates a random seed which it keeps private. The client seed is then combined with the server seed. This combination is then hashed and shown to the client <em>before</em> a random part of a game takes place.</p>
                    ...
                    <div class="col">
                        ...
                        <p class="text-muted">Use the form below to verify a dataset of provably fair information. This data will run through the PHP algorithm found in the source code in the <a href="https://github.com/gamebetr/provable/blob/master/src/Provable.php">Github Provable repository</a>.</p>
                    </div>
                </div>
            </div>
        </div>
